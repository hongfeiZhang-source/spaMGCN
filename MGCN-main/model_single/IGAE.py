...
class IGAE_encoder(nn.Module):
    ...
    def __init__(self, gae_n_enc_1, gae_n_enc_2, gae_n_enc_3, n_input):
        ...
        self.gnn_1 = NGNNLayer(n_input, gae_n_enc_1,  order=2)
        self.gnn_2 = NGNNLayer(gae_n_enc_1, gae_n_enc_2,  order=2)
        self.gnn_3 = NGNNLayer(gae_n_enc_2, gae_n_enc_3,  order=2)
        self.s = nn.Sigmoid()
...
class IGAE_decoder(nn.Module):
    ...
    def __init__(self, gae_n_dec_1, gae_n_dec_2, gae_n_dec_3, n_input):
        ...
        self.gnn_4 = NGNNLayer(gae_n_dec_1, gae_n_dec_2,  order=2)
        self.gnn_5 = NGNNLayer(gae_n_dec_2, gae_n_dec_3, order=2)
        self.gnn_6 = NGNNLayer(gae_n_dec_3, n_input,  order=2)
